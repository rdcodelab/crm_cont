    ...
    <section class="wrapper site-min-height">
        ...
        <div class="row mt">
            <div class="col-lg-12">
                ...
                ?>
                <form action="<?=base_url('/arquivos/editar/'.$arquivo->idarquivos); ?>" method="post">
                    <div class="msg_return"></div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?=$this->session->userdata('nome_cliente'); ?>" class="form-control" disabled />                            
                        </div>
                        ...
                        <div class="form-goup">
                            <a href="<?=base_url('/arquivos/'); ?>" title="Voltar" class="label label-default">Voltar</a>
                            <input type="submit" class="btn btn-primary" value="Salvar dados" />
                            <input type="hidden" name="arquivo" value="<?=$arquivo->idarquivos; ?>" />
                            <small>Arquivo cadastrado em <?=dataBR($arquivo->data_cadastro); ?></smal>
                        </div>
                </form>
            </div>
        </div>
...
<?php echo form_open_multipart('arquivos/atualizaFile'); ?>    
