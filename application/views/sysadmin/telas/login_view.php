...
<html lang="en">
  <head>
    ...
    <title>RDCode - Sistema de Gestão - Acesso Restrito</title>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
                    ...
                    <form class="form-login" action="<?=base_url('/admin/home/login'); ?>" method="post">
        ...
        $(document).ready(function(){
            ...
            $('#btnSenha').on('click', function(){
                ...
                $.ajax({
                    type: 'POST',
                    data: {'usuario': email},
                    url: '<?=base_url('/admin/home/recupera_senha'); ?>',
                    beforeSend: function(){
