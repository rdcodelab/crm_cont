...
<header class="header black-bg">
      ...
      <div class="nav notify-row" id="top_menu">
          ...
          <ul class="nav top-menu">       
              <li><a href="<?=base_url('/admin/usuarios/editar/'.$this->session->userdata('id')); ?>" title="Meu perfil"><i class="fa fa-user"></i></a></li>
              ...
              <li id="header_inbox_bar" class="dropdown">
                  ...
                  <ul class="dropdown-menu extended inbox">
                      ...
                      ?>
                      <li>
                          <a href="<?=base_url('admin/chamados/ver/'.$msg->id_chamados); ?>" title="Ver mensagem">                              
                              <span class="subject">
                      ...
                      <li>
                          <a href="<?=base_url('admin/chamados/'); ?>" title="Ver todos os chamados">Ver chamados</a>
                      </li>
                  </ul>
              </li>
              <li id="header_inbox_bar" class="dropdown">
                  ...
                  <ul class="dropdown-menu extended inbox">
                      ...
                      <li>
                          <?php
                            // define mensagem
                            if(count($tarefas) == 0){
                                $msg_chamada = 'Você não esta trabalhando em nenhuma tarefa.';
                            }elseif(count($tarefas) == 1){
                                $msg_chamada = 'Você possui 1 tarefa pendente.';                                
                            }else{
                                $msg_chamada = "Você possui ". count($tarefas)." tarefas pendentes.";
                            }
                          ?>
                          <p class="green"><?=$msg_chamada; ?></p>
                      </li>
                      ...
                      <li>
                          <a href="<?=base_url('admin/tarefas/'); ?>" title="Ver todos as tarefas">Ver tarefas</a>
                      </li>
                  </ul>
              </li>
              <!-- inbox dropdown end -->
              <li id="header_inbox_bar" class="dropdown abre_notificacao"></li>
          </ul>
          <!--  notification end -->
      </div>
      <div class="top-menu">
        <ul class="nav pull-right top-menu">            
            <li><a class="logout" href="<?=base_url('/admin/home/logout'); ?>"><i class="glyphicon glyphicon-log-out"></i> Sair</a></li>
        </ul>
      </div>
  </header>
<!--header end-->