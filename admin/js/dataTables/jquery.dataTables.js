...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Não há dados na tabela" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			/**
			 * When a user filters the information in a tablSe, this string is appended
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(_MAX_ registros totais filtrados)",
